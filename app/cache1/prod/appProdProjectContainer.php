...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->aliases = array(
            ...
            'security.user_checker.admin' => 'security.user_checker.main',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'energyvalue_dev', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_00000000246af81d0000000076012ae64faaa55e402a390aabf9a5a8e052aad2(
        ...
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[2].'\\Application\\Sonata\\UserBundle\\Resources\\config\\doctrine') => 'Application\\Sonata\\UserBundle\\Entity', ($this->targetDirs[3].'\\vendor\\sonata-project\\user-bundle\\Resources\\config\\doctrine') => 'Sonata\\UserBundle\\Entity', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine') => 'FOS\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0168ab432ca00f9461ac400169e8627e183224e87353a95dcbc088b619f313a4');
    ...
    protected function getSecurity_Firewall_Map_Context_AdminService()
    {
        ...
        $f = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, '/admin/login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'sonata_user_admin_security_logout'));
        ...
        $g->setOptions(array('login_path' => 'sonata_user_admin_security_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $h->setOptions(array('login_path' => 'sonata_user_admin_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.admin'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $e, $this->get('security.authentication.session_strategy'), $a, 'admin', $g, $h, array('use_forward' => true, 'check_path' => 'sonata_user_admin_security_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $d, $this->get('event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58bd593d4cf4c3.20862531', $d, $e), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'admin', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($c, $a, 'sonata_user_admin_security_login', true), NULL, NULL, $d, false));
    }
    ...
    {
        $this->services['sonata.admin.security.handler'] = $instance = new \Sonata\AdminBundle\Security\Handler\AclSecurityHandler($this->get('security.token_storage'), $this->get('security.authorization_checker'), $this->get('security.acl.provider', ContainerInterface::NULL_ON_INVALID_REFERENCE), 'Sonata\\AdminBundle\\Security\\Acl\\Permission\\MaskBuilder', array(0 => 'ROLE_SUPER_ADMIN'));
    ...
    {
        return $this->services['sonata.user.editable_role_builder'] = new \Sonata\UserBundle\Security\EditableRolesBuilder($this->get('security.token_storage'), $this->get('security.authorization_checker'), $this->get('sonata.admin.pool'), array('ROLE_SONATA_FOO_READER' => array(0 => 'ROLE_SONATA_ADMIN_VAULT_USER_LIST', 1 => 'ROLE_SONATA_ADMIN_VAULT_USER_VIEW'), 'ROLE_SONATA_FOO_EDITOR' => array(0 => 'ROLE_SONATA_ADMIN_VAULT_USER_CREATE', 1 => 'ROLE_SONATA_ADMIN_VAULT_USER_EDIT'), 'ROLE_SONATA_FOO_ADMIN' => array(0 => 'ROLE_SONATA_ADMIN_VAULT_USER_DELETE', 1 => 'ROLE_SONATA_ADMIN_VAULT_USER_EXPORT'), 'ROLE_STAFF' => array(0 => 'ROLE_USER', 1 => 'ROLE_SONATA_FOO_READER'), 'ROLE_ADMIN' => array(0 => 'ROLE_STAFF', 1 => 'ROLE_SONATA_FOO_EDITOR', 2 => 'ROLE_SONATA_FOO_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_STAFF', 2 => 'ROLE_ALLOWED_TO_SWITCH', 3 => 'ROLE_USER', 4 => 'ROLE_SONATA_ADMIN')));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58bd593d4cf4c3.20862531'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'admin', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58bd593d4cf4c3.20862531')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_SONATA_FOO_READER' => array(0 => 'ROLE_SONATA_ADMIN_VAULT_USER_LIST', 1 => 'ROLE_SONATA_ADMIN_VAULT_USER_VIEW'), 'ROLE_SONATA_FOO_EDITOR' => array(0 => 'ROLE_SONATA_ADMIN_VAULT_USER_CREATE', 1 => 'ROLE_SONATA_ADMIN_VAULT_USER_EDIT'), 'ROLE_SONATA_FOO_ADMIN' => array(0 => 'ROLE_SONATA_ADMIN_VAULT_USER_DELETE', 1 => 'ROLE_SONATA_ADMIN_VAULT_USER_EXPORT'), 'ROLE_STAFF' => array(0 => 'ROLE_USER', 1 => 'ROLE_SONATA_FOO_READER'), 'ROLE_ADMIN' => array(0 => 'ROLE_STAFF', 1 => 'ROLE_SONATA_FOO_EDITOR', 2 => 'ROLE_SONATA_FOO_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_STAFF', 2 => 'ROLE_ALLOWED_TO_SWITCH', 3 => 'ROLE_USER', 4 => 'ROLE_SONATA_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'security.role_hierarchy.roles' => array(
                'ROLE_SONATA_FOO_READER' => array(
                    0 => 'ROLE_SONATA_ADMIN_VAULT_USER_LIST',
                    1 => 'ROLE_SONATA_ADMIN_VAULT_USER_VIEW',
                ),
                'ROLE_SONATA_FOO_EDITOR' => array(
                    0 => 'ROLE_SONATA_ADMIN_VAULT_USER_CREATE',
                    1 => 'ROLE_SONATA_ADMIN_VAULT_USER_EDIT',
                ),
                'ROLE_SONATA_FOO_ADMIN' => array(
                    0 => 'ROLE_SONATA_ADMIN_VAULT_USER_DELETE',
                    1 => 'ROLE_SONATA_ADMIN_VAULT_USER_EXPORT',
                ),
                'ROLE_STAFF' => array(
                    0 => 'ROLE_USER',
                    1 => 'ROLE_SONATA_FOO_READER',
                ),
                'ROLE_ADMIN' => array(
                    0 => 'ROLE_STAFF',
...
class DoctrineORMEntityManager_00000000246af81d0000000076012ae64faaa55e402a390aabf9a5a8e052aad2 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder58bd593e0eafb551383325 = null;
    private $initializer58bd593e0eb0b450982427 = null;
    private static $publicProperties58bd593e0eac5035252811 = array(
        
    );
    public function getConnection()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'getConnection', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'getMetadataFactory', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'getExpressionBuilder', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'beginTransaction', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->beginTransaction();
    }
    public function transactional($func)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'transactional', array('func' => $func), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->transactional($func);
    }
    public function commit()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'commit', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->commit();
    }
    public function rollback()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'rollback', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'getClassMetadata', array('className' => $className), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'createQuery', array('dql' => $dql), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'createNamedQuery', array('name' => $name), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'createQueryBuilder', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'flush', array('entity' => $entity), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->flush($entity);
    }
    public function find($entityName, $id, $lockMode = 0, $lockVersion = null)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->find($entityName, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'clear', array('entityName' => $entityName), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->clear($entityName);
    }
    public function close()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'close', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->close();
    }
    public function persist($entity)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'persist', array('entity' => $entity), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'remove', array('entity' => $entity), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'refresh', array('entity' => $entity), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'detach', array('entity' => $entity), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'merge', array('entity' => $entity), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'getRepository', array('entityName' => $entityName), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'contains', array('entity' => $entity), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'getEventManager', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'getConfiguration', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'isOpen', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'getUnitOfWork', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'getProxyFactory', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'initializeObject', array('obj' => $obj), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'getFilters', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'isFiltersStateClean', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'hasFilters', array(), $this->initializer58bd593e0eb0b450982427);
        return $this->valueHolder58bd593e0eafb551383325->hasFilters();
    }
    public function __construct($initializer)
    {
        $this->initializer58bd593e0eb0b450982427 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, '__get', array('name' => $name), $this->initializer58bd593e0eb0b450982427);
        if (isset(self::$publicProperties58bd593e0eac5035252811[$name])) {
            return $this->valueHolder58bd593e0eafb551383325->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58bd593e0eafb551383325;
    ...
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58bd593e0eb0b450982427);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58bd593e0eafb551383325;
    ...
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, '__isset', array('name' => $name), $this->initializer58bd593e0eb0b450982427);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58bd593e0eafb551383325;
    ...
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, '__unset', array('name' => $name), $this->initializer58bd593e0eb0b450982427);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58bd593e0eafb551383325;
    ...
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, '__clone', array(), $this->initializer58bd593e0eb0b450982427);
        $this->valueHolder58bd593e0eafb551383325 = clone $this->valueHolder58bd593e0eafb551383325;
    }
    public function __sleep()
    {
        $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, '__sleep', array(), $this->initializer58bd593e0eb0b450982427);
        return array('valueHolder58bd593e0eafb551383325');
    }
    ...
    {
        return $this->initializer58bd593e0eb0b450982427;
    }
    public function initializeProxy()
    {
        return $this->initializer58bd593e0eb0b450982427 && $this->initializer58bd593e0eb0b450982427->__invoke($this->valueHolder58bd593e0eafb551383325, $this, 'initializeProxy', array(), $this->initializer58bd593e0eb0b450982427);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder58bd593e0eafb551383325;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder58bd593e0eafb551383325;
    }
}
