 ...
 */
class Version20170309084805 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE base_lookup (id BIGINT(12) AUTO_INCREMENT NOT NULL, parent_id BIGINT(12) DEFAULT NULL, is_deleted TINYINT(1) DEFAULT NULL, modifiedby BIGINT(12) NOT NULL, createdon DATETIME NOT NULL, updatedon DATETIME NOT NULL, code VARCHAR(60) NOT NULL, name VARCHAR(60) NOT NULL, description VARCHAR(100) NOT NULL, INDEX IDX_987C296C727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE billing (id BIGINT(12) AUTO_INCREMENT NOT NULL, meter_id BIGINT(12) DEFAULT NULL, is_deleted TINYINT(1) DEFAULT NULL, modifiedby BIGINT(12) NOT NULL, createdon DATETIME NOT NULL, updatedon DATETIME NOT NULL, units NUMERIC(10, 3) NOT NULL, amount NUMERIC(10, 2) NOT NULL, duos NUMERIC(10, 3) NOT NULL, period DATETIME NOT NULL, INDEX IDX_EC224CAA6E15CA9E (meter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE billing_detail (id BIGINT(12) AUTO_INCREMENT NOT NULL, billing_id BIGINT(12) DEFAULT NULL, type BIGINT(12) DEFAULT NULL, is_deleted TINYINT(1) DEFAULT NULL, modifiedby BIGINT(12) NOT NULL, createdon DATETIME NOT NULL, updatedon DATETIME NOT NULL, code VARCHAR(50) NOT NULL, value VARCHAR(60) NOT NULL, INDEX IDX_6BDC5CC33B025C87 (billing_id), INDEX IDX_6BDC5CC38CDE5729 (type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE consumption (id BIGINT(12) AUTO_INCREMENT NOT NULL, meter_id BIGINT(12) DEFAULT NULL, is_deleted TINYINT(1) DEFAULT NULL, modifiedby BIGINT(12) NOT NULL, createdon DATETIME NOT NULL, updatedon DATETIME NOT NULL, period DATETIME DEFAULT NULL, bracket INT DEFAULT NULL, unit NUMERIC(10, 3) NOT NULL, INDEX IDX_2CFF2DF96E15CA9E (meter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contract (id BIGINT(12) AUTO_INCREMENT NOT NULL, profile_id BIGINT(12) DEFAULT NULL, contract_type BIGINT(12) DEFAULT NULL, is_deleted TINYINT(1) DEFAULT NULL, modifiedby BIGINT(12) NOT NULL, createdon DATETIME NOT NULL, updatedon DATETIME NOT NULL, period DATETIME DEFAULT NULL, notes VARCHAR(200) DEFAULT NULL, value NUMERIC(10, 3) DEFAULT NULL, isDefault TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_E98F2859CCFA12B8 (profile_id), INDEX IDX_E98F2859E4AB1941 (contract_type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contract_consumption (id BIGINT(12) AUTO_INCREMENT NOT NULL, contract_id BIGINT(12) NOT NULL, consumption_id BIGINT(12) NOT NULL, is_deleted TINYINT(1) DEFAULT NULL, modifiedby BIGINT(12) NOT NULL, createdon DATETIME NOT NULL, updatedon DATETIME NOT NULL, cost NUMERIC(12, 3) NOT NULL, INDEX IDX_6E54F4342576E0FD (contract_id), INDEX IDX_6E54F434D17C3821 (consumption_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE council (id BIGINT(12) AUTO_INCREMENT NOT NULL, profile_id BIGINT(12) DEFAULT NULL, council_type BIGINT(12) DEFAULT NULL, is_deleted TINYINT(1) DEFAULT NULL, modifiedby BIGINT(12) NOT NULL, createdon DATETIME NOT NULL, updatedon DATETIME NOT NULL, code VARCHAR(50) NOT NULL, name VARCHAR(50) NOT NULL, description VARCHAR(100) DEFAULT NULL, INDEX IDX_8EF153E2CCFA12B8 (profile_id), INDEX IDX_8EF153E24B51BFE3 (council_type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lookup (id BIGINT(12) AUTO_INCREMENT NOT NULL, base_lookup_id BIGINT(12) DEFAULT NULL, is_deleted TINYINT(1) DEFAULT NULL, modifiedby BIGINT(12) NOT NULL, createdon DATETIME NOT NULL, updatedon DATETIME NOT NULL, code VARCHAR(50) NOT NULL, name VARCHAR(50) NOT NULL, description VARCHAR(100) NOT NULL, INDEX IDX_F01CB1053A795510 (base_lookup_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE meter (id BIGINT(12) AUTO_INCREMENT NOT NULL, site_id BIGINT(12) DEFAULT NULL, meter_type BIGINT(12) DEFAULT NULL, unit_type BIGINT(12) DEFAULT NULL, is_deleted TINYINT(1) DEFAULT NULL, modifiedby BIGINT(12) NOT NULL, createdon DATETIME NOT NULL, updatedon DATETIME NOT NULL, code VARCHAR(50) NOT NULL, meter_number VARCHAR(50) NOT NULL, description VARCHAR(100) DEFAULT NULL, INDEX IDX_5E010CAEF6BD1646 (site_id), INDEX IDX_5E010CAE71C0A390 (meter_type), INDEX IDX_5E010CAE18B673 (unit_type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE profile (id BIGINT(12) AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, is_deleted TINYINT(1) DEFAULT NULL, modifiedby BIGINT(12) NOT NULL, createdon DATETIME NOT NULL, updatedon DATETIME NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, title VARCHAR(50) NOT NULL, email VARCHAR(50) NOT NULL, gender TINYINT(1) DEFAULT \'1\' NOT NULL, address VARCHAR(100) NOT NULL, INDEX IDX_8157AA0FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site (id BIGINT(12) AUTO_INCREMENT NOT NULL, council_id BIGINT(12) DEFAULT NULL, site_type BIGINT(12) DEFAULT NULL, is_deleted TINYINT(1) DEFAULT NULL, modifiedby BIGINT(12) NOT NULL, createdon DATETIME NOT NULL, updatedon DATETIME NOT NULL, code VARCHAR(50) NOT NULL, name VARCHAR(50) NOT NULL, description VARCHAR(50) DEFAULT NULL, INDEX IDX_694309E4970B0D6D (council_id), INDEX IDX_694309E4B744EAD0 (site_type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fos_user (id BIGINT(12) AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, username_canonical VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, email_canonical VARCHAR(255) NOT NULL, enabled TINYINT(1) NOT NULL, salt VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, last_login DATETIME DEFAULT NULL, locked TINYINT(1) NOT NULL, expired TINYINT(1) NOT NULL, expires_at DATETIME DEFAULT NULL, confirmation_token VARCHAR(255) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', credentials_expired TINYINT(1) NOT NULL, credentials_expire_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_957A647992FC23A8 (username_canonical), UNIQUE INDEX UNIQ_957A6479A0D96FBF (email_canonical), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
